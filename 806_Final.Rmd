...
TotalEi ~ Site + Treatment:
 Each relationship we looked at followed the same statistical methodlogy, which starts with an anova. After being ran through an anova, it was found that site had a significant effect on the various treatments, with a p-value of 0.00344**. After the anova,the residuals and predicted values were found and plotted. This resulted in a vase shaped graph. A Shapiro-Wilk test was used to test for normaility among the residuals, this resulted with a p-value of 0.3441 which is not significant. THis was then ran thorugh a Levene's Test for the homogientiy of variances. Where it was found to be not significant with a p-value of 0.5239. A Tukey 1-df test was performed to test for non-additivity, this resulted in  one significant value in site with a p-value of  0.003725. However that test was done to check the significance of sq_preds which was not significant. Finally each treatment and site was run through a HSD ranking system. The first one that was done was for Total Ei and Treatments, which resulted in the ranking of: 1. BTH (70.68), 2. MF+BTH (68.19), 3. C (62.92), 4. MJ (62,15). HOwever this was found to be nonsignificant. The second one, done on Total Ei and Site, resulted in: 1. Woodman Farm (71.54), 2. Kingman Farm (68.01), 3. Evelyn (50.38). This was found to be a significant differnce.
...
TotalEi ~ Treatment +Inoculation
  Starting off with the anova, it was found that inoculation was the only significant value of 2.01e-07*** . Similarly the residuals and predicted values were found and plotted, resulting in a vase shaped graph. These were then put into the Shapiro-Wilks tests which found that they are marginally significant at a p-value of 0.02844. A Tukey 1-df test was then done, which showed that inoculation (p=1.839e-09*** ) and site (3.262e-05*** ) were both highly significant, however sq_preds was not with a value of 0.5085. The different inoculation types were then compared to the control by using a Dunnett's test. Where it was found that both D and M were significantly different compared to the control. Finally the HSD ranking was done for treatment, resulting in no significance between any treatment. While the HSD tanking done on inoculation found significance between control and D+M, however D was not significant with M across treatments.
